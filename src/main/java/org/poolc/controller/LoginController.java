...
public class LoginController {
    ...
    @PostMapping("/login")
    public String login(@Valid @ModelAttribute("loginForm") LoginFormController form, BindingResult bindingResult,
    ...
    @RequestMapping(value = "/loginedMembers/logout", method = {RequestMethod.GET, RequestMethod.POST})
